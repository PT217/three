    ...
    <div class="cropper-box">
      ...
      <div class="footer-btn">
        ...
        <div class="upload-btn">
          <el-button size="mini" type="success" @click="uploadImg('blob')">保存封面 <i class="el-icon-upload"></i></el-button>
        </div>
      </div>
    </div>
    <!--预览效果图-->
    ...
    uploadImg(type) {
      if (type === "blob") {
        ...
        this.$refs.cropper.getCropBlob((blob) => {
          this.$emit("uploadImgSuccess", { name: this.fileName, blob: blob });
        });
      }
    },
  },
